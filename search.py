...
def breadth_first_search(problem, search_type=uninformed_tree_search):
    #  todo()
    #added return for breadth first search by calling FIFIQueue as it is First in first out
    return (uninformed_tree_search(problem,FIFOQueue()))
...
def depth_first_search(problem, search_type=uninformed_tree_search):
    # todo()
    #added return for depth first search by calling LIFOQueue as it follows stack(last in first out)
    return (uninformed_tree_search(problem, LIFOQueue()))
#______________________________________________________________________________
# Informed Search
